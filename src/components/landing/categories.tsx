...
export function TeamSectionOne() {
  return (
    <section className="py-8 px-8 lg:py-16 bg-dark">
      <div className="container mx-auto">
        <div className="mb-24 w-1/2">
          <Typography variant="h2" color="white" className="mb-4">
            Shop by category
          </Typography>
          <Typography variant="lead" className="l:px-20 text-gray-400">
            This is the paragraph where you can write more details about your
            categories. Keep you user engaged by providing meaningful
            information.
          </Typography>
        </div>
