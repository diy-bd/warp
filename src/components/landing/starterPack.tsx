...
export function ContentSectionOne() {
  return (
    //make this section dark
    <ThemeProvider>
      <section className="py-16 px-8 lg:py-28 bg-dark border-t border-gray-700">
        <div className="container mx-auto grid items-center lg:grid-cols-2">
          <div className="row-start-2 mt-12 lg:row-auto lg:mt-0 lg:pr-12">
            <Typography variant="h2" color="white" className="mb-6">
              Basic Starter Pack
            </Typography>
            <Typography variant="lead" className="mb-12 text-gray-400">
              I always felt like I could do anything. That&apos;s the main thing
              people are controlled by! They&apos;re slowed down by{' '}
              <a
                href="#"
                className="underline underline-offset-4 transition-colors hover:text-blue-500 text-gray-400"
              >
